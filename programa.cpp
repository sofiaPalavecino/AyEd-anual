...
void imprimirRangoEdades(tVotos votos, tListas listas);
...
void tablaDHont(tListas listas, votoInvalido & votosInvalidos, tVotos votos){
    ...
    imprimirRangoEdades(votos, listas);
    cout.rdbuf(sbuf);
...
void MostrarRangosEdad(voto v, int listaAnterior,  int & hasta18, int & hasta30, int & hasta50, int & masDe50){
    if(listaAnterior > 0 && listaAnterior < _TOPE_LISTAS){
        ...
        cout << setw(conseguirMargen(39,hasta18))<<"| " << hasta30;
        cout << setw(conseguirMargen(39,hasta30))<<"| " << hasta50;
        cout << setw(conseguirMargen(39,hasta50))<<"| " << masDe50 << endl;
        hasta18=0;
        hasta30=0;
        hasta50=0;
        masDe50=0;
